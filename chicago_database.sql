...
) FROM '.\data\clinics.csv' WITH (FORMAT csv, HEADER);

CREATE TABLE data.div (
    id	integer	PRIMARY KEY,
    case_id	integer	REFERENCE crimes,
    case_participant_id	integer REFERENCE crimes,
    received_date date,
...
\copy  data.div (id, case_id, case_participant_id, received_date, offense_category, diversion_program, referral_date, diversion_count, primary_charge_offense_title, statute, race, gender, diversion_result, diversion_closed_date) FROM '.\data.div.csv' WITH (FORMAT csv, HEADER);
...
\copy  HCSBHP (id, se, g, l, a, p, d, v) FROM '.\HCSBHP.csv' WITH (FORMAT csv, HEADER);
...
\copy  HDDRR (id, se, g, l, a, p, d, v) FROM '.\HDDRR.csv' WITH (FORMAT csv, HEADER);
...
\copy  HDSZR (id, se, g, l, a, p, d, v) FROM '.\HDSZR.csv' WITH (FORMAT csv, HEADER);
